package com.quraanali.daterangepicker.models
...
import com.quraanali.daterangepicker.models.CalendarStyleAttributes.Companion.DEFAULT_FIXED_DAYS_SELECTION
...
class CalendarStyleAttrImpl(context: Context, attributeSet: AttributeSet? = null) :
    ...
    override var dateSelectionMode = CalendarStyleAttributes.DateSelectionMode.FREE_RANGE
    override var fixedDaysSelectionNumber: Int = DEFAULT_FIXED_DAYS_SELECTION
        set(value) {
            if (dateSelectionMode !== CalendarStyleAttributes.DateSelectionMode.FIXED_RANGE) {
    ...
    private fun setAttributes(context: Context, attributeSet: AttributeSet?) {
        if (attributeSet != null) {
            ...
            try {
                ...
                dateSelectionMode = CalendarStyleAttributes.DateSelectionMode.values()[ta.getInt(R.styleable.DateRangeMonthView_date_selection_mode, 0)]
            } finally {
                ta.recycle()
            }
        }
